...
export const locationData = [
  {
    ...
    fullDescription: "The ancient city of Salamis was founded in the 11th century BC and became the capital of Cyprus in the 8th century BC. Today, visitors can explore extensive ruins including a gymnasium, Roman baths, an amphitheater, and Byzantine basilicas.",
    rating: 4.7,
  ...
  },
  {
    ...
    fullDescription: "This impressive 16th-century castle dominates Kyrenia harbor and offers stunning views across the Mediterranean. Inside, you can find the Shipwreck Museum featuring a well-preserved merchant vessel from the 3rd century BC.",
    rating: 4.5,
  ...
  },
  {
    ...
    fullDescription: "Once a glamorous tourist destination, Varosha became a ghost town after the Turkish invasion of 1974. Recently partially reopened to visitors, it offers a unique glimpse into a frozen moment in time with abandoned hotels and streets.",
    rating: 4.2,
  ...
  },
  {
    ...
    fullDescription: "This Gothic abbey was built in the 13th century by Augustinian monks and is considered the most beautiful Gothic building in Cyprus. The ruins are well-preserved and offer magnificent views of Kyrenia and the Mediterranean.",
    rating: 4.8,
...
export const eventsData = [
  { 
    ...
    fullDescription: 'Experience the best electronic music with international and local DJs at this beachside festival. Featuring food vendors, art installations, and a vibrant atmosphere as you dance from day into night.',
    location: 'Escape Beach Club, Kyrenia',
    coordinates: { lat: 35.3560, lng: 33.2030 }, // Added coordinates for map integration
    category: "Music",
    schedule: [
      '12:00 - Gates Open',
      '13:00 - First DJ Set',
  ...
  { 
    ...
    fullDescription: 'A night of laughs with local and international stand-up comedians. Enjoy dinner and drinks while being entertained by some of the best comedy talents from around the region.',
  ...
  { 
    ...
    fullDescription: 'Witness world champion billiards player Korhan Sayginer demonstrate his incredible skills in this exhibition match. A rare opportunity to see one of the greatest players in the sport up close.',
  ...
  { 
    ...
    fullDescription: 'Celebrate traditional Turkish and Cypriot folk dancing with this colorful and energetic performance. The Zeybek dance group presents authentic costumes, music, and choreography in this cultural spectacle.',
...
// API Keys - In a production environment, these should be in environment variables
export const API_KEYS = {
  GOOGLE_MAPS: "AIzaSyAS7hPlKlbKdAPg7waHCR6KfySgD1HPN-Y",
  GEMINI: "AIzaSyDe6vVwe0mQhv_s2qw5uLBos-99I4aXWOE"
};
